...
import 'package:charch_mangments/model/adminside/addinvites.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class admininvites extends StatefulWidget {
  final String title = '';

  admininvites({Key? key}) : super(key: key);

  @override
  State<admininvites> createState() => _admininvitesState();
}

class _admininvitesState extends State<admininvites> {
          ...
          TextButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: ((context) => addadmininvites())));
            },
          )
        ],
      ),
