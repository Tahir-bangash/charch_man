...
import 'package:charch_mangments/model/adminside/add_cell.dart';
import 'package:charch_mangments/model/adminside/add_cell_member.dart';
    ...
    return  Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                Column(
                  ...
                  MaterialPageRoute(builder: ((context) => add_cell_member())));
                                },
                                child: Text('view',
                                    style: TextStyle(color: Colors.black))),
                          ),
          ...
          TextButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: ((context) => add_cell())));
            },
          )
        ])));
  }
